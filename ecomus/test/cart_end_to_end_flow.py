...
async def test_successful(register_page: Page, login_page: Page, homeTo_page: Page, auto_delete_user_e2e): #, home_page: Page, add_to_cart: Page, checkout_page: Page
    ...
    await homeTo_page.search_input_fill("Paddle")
    await expect(homeTo_page.page).to_have_url("https://automation-portal-bootcamp.vercel.app/search?query=Paddle")
